...
class LoginTestTrue(unittest.TestCase):
    ...
    # Step
        ...
        mail_prompt.send_keys("piotrryszewski@gmail.com")
    ...
    # Step
        ...
        submit_login.click()
    # Step
        self.assertIn("My account - My Store", driver.title)

    def tearDown(self):
        self.driver.close()


class LoginTestFalse(unittest.TestCase):
    ...
    # Step
        password_prompt = driver.find_element_by_id("passwd")
        password_prompt.send_keys("jasiudupa")
